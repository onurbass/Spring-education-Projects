...
import com.onurbas.excepiton.UserManagerException;
...
import com.onurbas.repository.IUserProfileRepository;
...
public class UserProfileService  extends ServiceManager<UserProfile,String> {
    ...
    public String updateUserProfile(UserProfileUpdateRequestDto dto) {
        ...
        if (!userProfile.get().getEmail().equals(dto.getEmail())||
            ...
            authManager.update(IUserMapper.INSTANCE.toUpdateRequestDto(userProfile.get()),"Bearer "+dto.getToken());
        }
